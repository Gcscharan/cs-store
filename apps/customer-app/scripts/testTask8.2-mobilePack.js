 ...
 * 
 * Usage:
 *   npm run test:task8.2-mobile-pack-js
 *   or
 *   node scripts/testTask8.2-mobilePack.js
 */
...
class Task82Tester {
  ...
  async testMobilePackWebUpdates() {
    ...
    const webSocketPromise = new Promise((resolve, reject) => {
      ...
      this.webSocket.on('order:status:changed', (data) => {
