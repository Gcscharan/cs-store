...
const assignDeliveryBoyToOrder = async (req, res) => {
    try {
        ...
        if (deliveryBoyId) {
            ...
            console.log(`✅ Smart assignment: ${assignedDeliveryBoy.name} (${assignmentResult.reason})`);
        }
        ...
        await smartAssignmentService_1.smartAssignmentService.updateDeliveryBoyRoute(assignedDeliveryBoy._id.toString(), orderCoordinates, order._id.toString());
        res.json({
            success: true,
...
const unassignDeliveryBoyFromOrder = async (req, res) => {
    try {
        ...
        if (deliveryBoy && deliveryBoy.assignedOrders.length === 0) {
            ...
            await smartAssignmentService_1.smartAssignmentService.clearDeliveryBoyRoute(deliveryBoyId.toString());
