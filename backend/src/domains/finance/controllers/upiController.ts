 ...
 */
export const verifyUpiId = async (
  req: Request<{}, UpiVerificationResponse, UpiVerificationRequest>,
  res: Response<UpiVerificationResponse>
): Promise<void> => {
  try {
    const { vpa } = req.body;
    ...
    const mockUpiData: { [key: string]: string } = {
