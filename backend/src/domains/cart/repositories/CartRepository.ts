...
export interface ICartRepository {
  ...
  updateOne(userId: string, updateData: any): Promise<any>;
  findByUserIdWithPopulate(userId: string): Promise<any>;
  atomicAddToCart(userId: string, productId: string, name: string, price: number, image: string, quantity: number): Promise<any>;
  atomicUpdateCartItem(userId: string, productId: string, quantity: number): Promise<any>;
  atomicRemoveFromCart(userId: string, productId: string): Promise<any>;
  atomicClearCart(userId: string): Promise<any>;
}
...
export class CartRepository implements ICartRepository {
  ...
  async findByUserIdWithPopulate(userId: string): Promise<any> {
  ...
  async updateOne(userId: string, updateData: any): Promise<any> {
  ...
  async atomicAddToCart(userId: string, productId: string, name: string, price: number, image: string, quantity: number): Promise<any> {
  ...
  async atomicUpdateCartItem(userId: string, productId: string, quantity: number): Promise<any> {
    // Convert productId to ObjectId for consistent comparison
    const productObjectId = new ObjectId(productId);
  ...
  async atomicRemoveFromCart(userId: string, productId: string): Promise<any> {
    // Convert productId to ObjectId for consistent comparison
    const productObjectId = new ObjectId(productId);
  ...
  async atomicClearCart(userId: string): Promise<any> {
    return await Cart.findOneAndUpdate(
      { userId },
      {
        $set: {
   ...
   */
  async cleanupDuplicateItems(userId: string): Promise<any> {
    return await Cart.findOneAndUpdate(
      { userId },
      [
        {
