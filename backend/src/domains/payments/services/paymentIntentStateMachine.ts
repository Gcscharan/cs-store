...
const ALLOWED: Record<PaymentIntentStatus, PaymentIntentStatus[]> = {
  CREATED: ["GATEWAY_ORDER_CREATED", "PAYMENT_PENDING_EXTERNAL", "PAYMENT_RECOVERABLE", "FAILED", "CANCELLED", "EXPIRED"],
  ...
  PAYMENT_PENDING_EXTERNAL: ["GATEWAY_ORDER_CREATED", "PAYMENT_PROCESSING", "PAYMENT_RECOVERABLE", "FAILED", "CANCELLED", "EXPIRED"],
