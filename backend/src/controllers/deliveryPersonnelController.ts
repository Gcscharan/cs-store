 ...
 * POST /api/delivery
 */
export const addDeliveryPersonnel = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
...
export const updateDeliveryPersonnel = async (
  ...
  try {
    ...
    if (availability) deliveryBoy.availability = availability;
    if (typeof isActive === "boolean") deliveryBoy.isActive = isActive;
...
export const deleteDeliveryPersonnel = async (
  ...
  try {
    ...
    if (deliveryBoy.userId) {
      await User.findByIdAndUpdate(deliveryBoy.userId, { role: "customer" });
    }
 ...
 */
export const updateDeliveryBoyLocation = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
 ...
 */
export const getDeliveryBoyRoute = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
    ...
    const route = await smartAssignmentService.getDeliveryBoyRoute(id);
 ...
 */
export const clearDeliveryBoyRoute = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
    ...
    await smartAssignmentService.clearDeliveryBoyRoute(id);
