...
const validatePincode = (pincode: string): boolean => {
  ...
  const isFromOtherState = invalidRanges.some(
    (range) => pincodeNum >= range.start && pincodeNum <= range.end
  );
...
const getPincodeErrorMessage = (pincode: string): string => {
...
export const validatePincodeController = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
...
export const validateBulkPincodesController = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
...
export const getValidPincodeRangesController = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
