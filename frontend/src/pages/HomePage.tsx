...
import { useState, useMemo, useEffect, useCallback, memo, type ReactNode, type MouseEvent } from "react";
...
const HomeGuestOnly = function HomeGuestOnly({ children }: { children: ReactNode }) {
...
const HomeTopSelling = function HomeTopSelling({ products }: { products: any[] }) {
...
const HomeFooter = function HomeFooter() {
