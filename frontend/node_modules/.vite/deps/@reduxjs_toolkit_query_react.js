...
import {
  ...
  useSelector,
  useStore
} from "./chunk-CR6CAEDG.js";
import {
  configureStore,
  createSelector
} from "./chunk-UTQQYG2Y.js";
import {
  require_react
...
function useStableQueryArgs(queryArgs) {
  const cache = (0, import_react2.useRef)(queryArgs);
  const copy = (0, import_react2.useMemo)(() => copyWithStructuralSharing(cache.current, queryArgs), [queryArgs]);
